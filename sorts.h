...
class Sorts{
    ...
    private:
        void mergeArray(vector<T>&, vector<T>&, int, int, int); //Mejor: O(n)    Promedio: O(n)    Peor: O(n)  
        void copyArray(vector<T>&, vector<T>&, int, int); //Mejor: O(n)    Promedio: O(n)    Peor: O(n)  

    public:
        void swap(std::vector<T> &, int, int); //Mejor: O(1)    Promedio: O(1)    Peor: O(1)
        void ordenaMerge(vector<T>&); //Mejor: O(nlogn)    Promedio: O(nlogn)    Peor: O(nlogn)  
        void mergeSplit(vector<T> &, vector<T>&, int, int); //Mejor: O(nlogn)    Promedio: O(nlogn)    Peor: O(nlogn)  
};
